...
class MobileNetV3(nn.Module):
    def __init__(self, width_mult=1.0,inchannel=3):
        super(MobileNetV3, self).__init__()
        input_channel = 16
        self.inchannel = inchannel
        self.final_out_channel = 0
        ...
        self.features = [conv_bn(self.inchannel, input_channel, (1, 2), nlin_layer= Hswish)]
        self.classifier = []
        ...
        for k, exp, c, se, nl, s in mobile_setting:
            ...
            self.final_out_channel = output_channel
...
if __name__ == "__main__":
    ...
    model = MobileNetV3(width_mult=2.0,inchannel=3).to(device)
    summary(model, (3, 30, 200))
