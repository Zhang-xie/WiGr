...
if __name__ == "__main__":
    root = Path("/media/yk/Samsung_T5/csi_301")
    a = CSI_301(root=root,roomid=[0],userid=[0],location=[0],data_shape='1D',chunk_size=30,num_shot=1,batch_size=5,mode="amplitude")
